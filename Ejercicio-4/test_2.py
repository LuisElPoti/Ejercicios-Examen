...
class TestCustomerClassifier(unittest.TestCase):
    ...
    def test_predict_class(self):
        ...
        self.mock_model.predict.return_value = np.array([[0.8, 0.1, 0.1]])

        # Simular un cliente de prueba
        test_client = [0.2, 0.1, 0.7]
        ...
        self.assertIn('El cliente pertenece a la clase: low', captured_output.getvalue())
