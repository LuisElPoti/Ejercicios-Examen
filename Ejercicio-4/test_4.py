...
class TestCustomerClassifier(unittest.TestCase):
    ...
    def test_predict_class(self):
        ...
        self.mock_model.predict.return_value = np.array([[0.33, 0.33, 0.34]])

        # Simular un cliente de prueba
        test_client = [0.3, 0.3, 0.4]
        ...
        self.assertIn('El cliente pertenece a la clase: high', captured_output.getvalue())
